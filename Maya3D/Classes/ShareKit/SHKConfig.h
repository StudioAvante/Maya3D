...
#ifdef KIN3D
// Kin 3D
#define SHKMyAppName			@"Kin 3D"
#define SHKMyAppURL				@"http://www.kin3d.mobi"
#else
// Maya 3D
#define SHKMyAppName			@"Maya 3D"
#define SHKMyAppURL				@"http://www.maya3d.mobi"
#endif
...
#define SHKFacebookKey				@"a4352cbc564f432e73cfc1705026d16e"
#define SHKFacebookSecret			@"098f0bcbffecb5026bbb8f48630079bc"
#define SHKFacebookSessionProxyURL  @""
#else
// Maya 3D
#define SHKFacebookUseSessionProxy  NO 
#define SHKFacebookKey				@"b231faffffe3203965df71c5260a9856"
#define SHKFacebookSecret			@"c31db8df443fb20942cadb6f5b799f8f"
#define SHKFacebookSessionProxyURL  @""
#endif
...
#ifdef KIN3D
// Kin 3D
#define SHKTwitterConsumerKey		@"nK05fAuixONH71qRW6eFA"
#define SHKTwitterSecret			@"VkTxPkOmtopfTtaYrhr19oOQFSEyLVh13OjgWO230"
#define SHKTwitterCallbackUrl		@"http://www.kin3d.mobi/callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"Roger_S" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
#else
// Maya 3D
#define SHKTwitterConsumerKey		@"ujHSQ5CEBfgu1J0jMSAgZw"
#define SHKTwitterSecret			@"96LdSllvJND7PTQMxTNVHp9P892wTCwo9yaRFBV4pc"
#define SHKTwitterCallbackUrl		@"http://www.maya3d.mobi/callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"Roger_S" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
#endif
